...
defaults write com.apple.terminal "Default Window Settings" -string "terminator"
defaults write com.apple.terminal "Startup Window Settings" -string "terminator"
